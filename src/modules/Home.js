                ...
                <div className='homeTop'>
                    ...
                    <div className='newsBox'>
                        ...
                        <div className='twitterBox'>
                            <img src={hr3} alt='-----'/>
                            <a className='twitterBoxLink' href='http://eepurl.com/tEQzX'>
                                <img className='twitterBoxLinkSrc' src={mailinglist} alt='OK Mailing List'/>
                                <div className='tBoxHoverCover'/>
                            </a>
                            <a className='twitterBoxLink' href='http://twitter.com/oktheater'>
                                <img className='twitterBoxLinkSrc' src={oktwitter} alt='OK Twitter'/>
                                <div className='tBoxHoverCover'/>
                            </a>
                        </div>
                    </div>
